...
---
For questions 3, the actions that are not quite appropriate are:
...
- Volunteers give their time freely, so it's better to ask questions in public spaces where everyone can see and help.
